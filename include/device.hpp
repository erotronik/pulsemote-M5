...
enum class DeviceType { splashscreen, device_mk312, device_coyote, device_thrustalot, device_bubblebottle, device_mqtt, device_loop, device_dgbutton, device_lovense,
 };
